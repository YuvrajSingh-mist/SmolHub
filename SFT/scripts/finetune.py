...
from SFT.helper.count_parameters import count_parameters
from tqdm import tqdm
from SFT.helper.visualize import Visualizer
...
class SFTTrainer:
    def __init__(self, model, train_dataloader, val_dataloader, test_dataloader, optimizer, loss_fn, scheduler=None):
        ...
        # self.model.train()
        self.eval_iters = config["Model"]["eval_iters"]
        ...
        self.scaler = GradScaler(enabled=(config["MAP"]["use_float16"]))
