...
class VisionModel(nn.Module):
    ...
    def __init__(
        ...
        super().__init__()
        self.model = AutoModel.from_pretrained("google/vit-base-patch16-224")
    ...
    def forward(self, x):
        ...
        # For ViT models, we take the [CLS] token embedding (first token) from last_hidden_state
        # This gives us the pooled representation of the image
